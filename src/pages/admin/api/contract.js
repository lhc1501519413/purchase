...
export function get_contract_list(params) {
  return request({
    method: 'GET',
    params: Object.assign({ c: 'Contract', a: 'get_contract_list', token: global.token },params)
  })
}
/* 合同详情 */
...
export function save_contract_info(data) {
  return request({
    method: 'POST',
    params: { c: 'Contract', a: 'save_contract_info', token: global.token },
    data
  })
}
/* 提交合同 */
export function submit_contract(code) {
  return request({
    method: 'POST',
    params: { c: 'Contract', a: 'submit_contract', token: global.token },
    data:{code}
  })
}
/* 最终确认合同 */
export function confirm_contract(code) {
  return request({
    method: 'POST',
    params: { c: 'Contract', a: 'confirm_contract', token: global.token },
    data:{code}
  })
}