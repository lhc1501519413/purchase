  ...
  <div id="changeDetail">
    ...
    <section class="content">
      ...
      <a-modal
        ...
        <section v-if="basic_nature_model_info.id===1">
          ...
          <div class="model-item">
            ...
            <span class="two">
              {{basic_nature_model_info.effect_start_date}} ~ {{!basic_nature_model_info.effect_end_date?'':basic_nature_model_info.effect_end_date.indexOf('9999')==-1?basic_nature_model_info.effect_end_date:'长期'}}
            </span>
          </div>
          <div class="model-item">
            <span class="one text-right">
        ...
        <section v-if="basic_nature_model_info.id===2">
          ...
          <div class="model-item">
            ...
            <span class="two">
              {{basic_nature_model_info.tax_effect_start_date}} ~ {{!basic_nature_model_info.tax_effect_end_date?'':basic_nature_model_info.tax_effect_end_date.indexOf('9999')==-1?basic_nature_model_info.tax_effect_end_date:'长期'}}
            </span>
          </div>
          <div class="model-item">
            <span class="one text-right">
        ...
        <section v-if="basic_nature_model_info.id===3">
          ...
          <div class="model-item">
            ...
            <span class="two">
              {{basic_nature_model_info.org_effect_start_date}} ~ {{!basic_nature_model_info.org_effect_end_date?'':basic_nature_model_info.org_effect_end_date.indexOf('9999')==-1?basic_nature_model_info.org_effect_end_date:'长期'}}
            </span>
          </div>
          <div class="model-item">
            <span class="one text-right">
        ...
        <section v-if="basic_nature_model_info.id===4">
          ...
          <div class="model-item">
            ...
            <span class="two">
              {{basic_nature_model_info.social_effect_start_date}} ~ {{!basic_nature_model_info.social_effect_end_date?'':basic_nature_model_info.social_effect_end_date.indexOf('9999')==-1?basic_nature_model_info.social_effect_end_date:'长期'}}
            </span>
          </div>
          <div class="model-item">
            <span class="one text-right">
      ...
      <a-table 
        ...
        >{{record.effect_start_date}}~{{!record.effect_end_date?'':record.effect_end_date.indexOf('9999')==-1?record.effect_end_date:'长期'}}</template>
        <template
          slot="is_effect"
          slot-scope="text, record"
...
export default {
  ...
  methods: {
    ...
    get_main_info(){
      ...
      get_special_nature_list().then(res=>{
      ...
      get_investment_base_info().then(res=>{
        ...
        this.investment_base_info.total_fund = res.data.total_fund; // 注册资本
        this.investment_base_info.actual_total_fund = res.data.actual_total_fund; // 实缴资本
      })
      get_investment_list().then(res=>{
        this.investment_list = res.data.list || [];
      }).catch();
      get_people_list().then(res=>{
