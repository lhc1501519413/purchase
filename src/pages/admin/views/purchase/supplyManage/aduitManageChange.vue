<template>
  <div id="aduitManageChange">
    <h5>
      <span>供应商审核 / 变更详情</span>
    </h5>
    <section class="content">
      ...
      <!-- <a-row v-if="basic_data.supply_type_name" class="mt-10 mb-10">
        <a-col :span="1" :offset='1'>
          <span class="change base">
            改
          </span>
        ...
        <a-col :span="7">
          {{basic_data.supply_type_name.value}}
        </a-col>
      </a-row> -->
      ...
      <a-row v-for='item of special_nature_data' :key='item.id' class="mt-10 mb-10">
