    ...
    <section class="content">
      ...
      <a-row class="mt-20">
        <a-col :span='10' :offset='10'>
          ...
          <a-button @click='$router.push({path:"/Contract/add_contract",query:{code:formData.code}})' type="primary">重新编辑</a-button>
        </a-col>
      </a-row>
  ...
  methods: {
    ...
    confirm(){
      ...
      self.$confirm({
        title: '确认此合同？',
        onOk() {
          confirm_bid_contract({code:self.formData.code}).then(res=>{
