...
export function get_user_com_list() {
  return request({
    method: 'GET',
    params: { c: 'Comdep', a: 'get_user_com_list', token: localStorage.getItem('token') }
  })
}
/* 获取公司价格执行区域列表 */
export function get_com_price_region(com_id) {
  ...
  return request({
    method: 'GET',
    params: { c: 'Comdep', a: 'get_com_price_region', token: localStorage.getItem('token'),com_id }
  })
}
/* 获取公司价格配送区域列表 */
export function get_shipping_region(price_region_id) {
  ...
  return request({
    method: 'GET',
    params: { c: 'Comdep', a: 'get_shipping_region', token: localStorage.getItem('token'),price_region_id }
  })
}
/* 获取全部公司价格配送区域列表 */
export function get_all_shipping_region(com_id) {
  return request({
    method: 'GET',
    params: Object.assign({ c: 'Comdep', a: 'get_all_shipping_region', token: localStorage.getItem('token') },com_id)
  })
}
/* 公告列表 */
